...
l1Tl3 = ['体育西路站', '广州东站']
l2Tl3 = ['嘉禾望岗站']
transfer_list = ['公园前站', '体育西路站', '广州东站', '嘉禾望岗站']
lenl1 = 16
lenl2 = 24
lenl3 = 31
lt = ['石牌桥站', '嘉禾望岗站', '昌岗站', '燕塘站', '人和站', '西塱站', '广州塔站', '东晓南站', '白云大道北站',
      '江泰路站', '沥滘站', '机场北站', '机场南站', '洛溪站', '同和站', '番禺广场站', '坑口站', '越秀公园站', '萧岗站',
      '广州南站', '天河客运站', '黄沙站', '三元里站', '江南西站', '白云公园站', '永泰站', '杨箕站', '珠江新城站',
      '海珠广场站', '高增站', '广州东站', '西门口站', '市二宫站', '体育中心站', '南浦站', '东山口站', '会江站',
      '五山站', '陈家祠站', '烈士陵园站', '白云文化广场站', '客村站', '大塘站', '龙归站', '体育西路站', '芳村站',
      '长寿路站', '飞翔公园站', '公园前站', '厦滘站', '花地湾站', '黄边站', '农讲所站', '纪念堂站', '石壁站', '华师站',
      '南洲站', '岗顶站', '梅花园站', '京溪南方医院站', '汉溪长隆站', '大石站', '市桥站', '林和西站', '江夏站',
      '广州火车站']
lenlt = 66
# 公园前站 48
# 体育西路站 44
